(function(){
    ...
    var employeeEventCalendarController = function( $scope, ActiveRecordFactory, $uibModal, moment , calendarConfig){
        ...
        {                   
          ...
          onClick: function(args) {                   
            ...
            ActiveRecordFactory.removeActiveRecord(args.calendarEvent.id, 'employee_calendar/removeEmployeeEvent').then(function( response ){
                if ( response.success ) {
                ...
                controller : function( $scope, getIsEditMode, getIndex, initEvent, geteventTypes ){
                    ...
                    $scope.modalOptions = {
                        ...
                        ok : function( result ){
                            ...
                            ActiveRecordFactory.saveActiveRecord($scope.event, $scope.isEditMode, 'employee_calendar/saveEmployeeEvent').then(function( response ){
                                if ( response ) {
    ...
    angular.module('cereliApp').controller('employeeEventCalendarController', employeeEventCalendarController);

    employeeEventCalendarController.$inject = [ '$scope', 'ActiveRecordFactory', '$uibModal', 'moment', 'calendarConfig' ];
